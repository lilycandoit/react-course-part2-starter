...
const TasksContext = React.createContext<TasksContexType>({} as TasksContexType);//can use null, but null does not really make sense >> so we use empty object and using 'as' to indicate the instance of TaskContextType. 
